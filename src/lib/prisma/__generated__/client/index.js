...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/lib/prisma/__generated__/client",
    "lib/prisma/__generated__/client",
  ]
...
path.join(process.cwd(), "src/lib/prisma/__generated__/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/lib/prisma/__generated__/client/schema.prisma")
